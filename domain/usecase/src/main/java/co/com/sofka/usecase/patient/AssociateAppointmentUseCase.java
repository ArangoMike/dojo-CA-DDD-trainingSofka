...
public class AssociateAppointmentUseCase extends UseCaseForCommand<AssociateAppointmentCommand> {
    ...
    public Mono<Boolean> validationsAppointment(Mono<AssociateAppointmentCommand> associateAppointmentCommand, String agendaid) {

      return associateAppointmentCommand.flatMap(command -> {
